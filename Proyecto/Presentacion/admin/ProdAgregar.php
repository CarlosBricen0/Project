                        ...
                        <table class="table-active">
                            <tbody>	
                                <tr>
                                    ...
                                    <td> <input type="text" name="TxtCod"class="form-control" value=""required placeholder="Ingrese el Codigo" placeholder="VENTI001"/> </td>
                                </tr>						
                                <tr>
                                    <td>Descripcion: </td>
                                    <td> <input type="text" name="TxtDesc"class="form-control" value=""required placeholder="Ingrese la Descripción"/> </td>
                                </tr>
                                <tr>
                                    <td>Stock: </td>
                                    <td> <input type="text" name="TxtStock"class="form-control" value="" required placeholder="Ingrese el Stock" placeholder="1 o 2"/> </td>
                                </tr>
                                <tr>
                                    <td>Precio Unitario: </td>
                                    <td> <input type="text" name="TxtPrecio"class="form-control" value="" required placeholder="Ingrese el precio" placeholder="10.000"/> </td>
                                </tr>
                                <tr>
                                    <td>Unidad Medida: </td>
                                    <td> <input type="text" name="TxtUndad"class="form-control" value="" required placeholder="Ingrese la unidad de medida" placeholder="10.000"/> </td>
                                </tr>
                                    <td colspan="2">
									<br>
