            ...
            <div class="panel panel-default">
				...
				<center>
                        ...
                        <table class="table table-striped">
							<form action="../../Controladores/ValidadorEmpresa.php" name="Eliminar" method="post">
								<tbody>
								<tr>
									<td>RUT</td>
									<td><input type="text" name="txtRut" class="form-control" value =""></input></td>
									<td><input type="submit" name="btnEliminar" class="btn" value ="Eliminar"></input></td>
