                    ...
                    <form action="../../Controladores/ValidadorCliente.php" name="Validador" method="post">
                        ...
                        <table class="table-active">
                            <tbody>
                                <tr>
                                    <td>Rut: </td>
                                    <td> <input type="text" name="TxtRut"class="form-control" value="<?php  if (isset($_REQUEST["Rut"])) { echo $Rut; } ?>" placeholder="Ej:11.111.111-k" pattern="[0-9]{1,2}.[0-9]{3}.[0-9]{3}-[0-9Kk]{1}" required title="EJ: 99.999.999-9"/>
                                ...
                                <tr>
                                    <td>Nombre: </td>
                                    <td> <input type="text" name="TxtNombre"class="form-control" value="<?php echo $row[1]; ?>"required placeholder="Ingrese su Nombre" title="Ingrese solo letras" /> </td>
                                </tr>
                                <tr>
                                    <td>Giro: </td>
                                    <td> <input type="text" name="TxtGiro"class="form-control" value="<?php echo $row[2]; ?>" required placeholder="Ingrese su Giro"  title="Ingrese solo letras"/> </td>
                                </tr>
                                <tr>
                                    <td>Direccion: </td>
                                    <td> <input type="text" name="TxtDireccion"class="form-control" value="<?php echo $row[3]; ?>" required placeholder="Ingrese su Direccion"/> </td>
                                </tr>
                                <tr>
                                    <td>Comuna: </td>
                                    <td> <input type="text" name="TxtComuna"class="form-control" value="<?php echo $row[4]; ?>" required placeholder="Ingrese su Direccion"/> </td>
                                </tr>
                                <tr>
                                    <td>Ciudad: </td>
                                    <td> <input type="text" name="TxtCiudad"class="form-control" value="<?php echo $row[5]; ?>" required placeholder="Ingrese su Direccion"/> </td>
                                </tr>
                                <tr>
                                    <td>Región: </td>
                                    <td> <input type="text" name="TxtRegion"class="form-control" value="<?php echo $row[6]; ?>" required placeholder="Ingrese su Direccion"/> </td>
                                </tr>
                                    <td colspan="2">
									<br>
