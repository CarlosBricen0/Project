<html lang="en">
    <head>
        ...
        if (isset($_REQUEST["Rut"])) {
            ...
            $cone = new Conexion();
            $query = "SELECT * FROM empresa where Rut = '$Rut'";
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="popup-inner">
                            <p>
                            <center>
                                <form action="../../Controladores/ValidadorEmpresa.php" name="Validador" method="post">
                                    <h1>Modificacion de Empresa</h1>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_REQUEST["Rut"])) {
                                                foreach ($cadena as $row):
                                                    ...
                                                    <tr>
                                                        <td>Razón Social: </td>
                                                        <td> <input type="text" name="TxtRazon"class="form-control" value="<?php echo $row[1]; ?>"required placeholder="Ingrese la Razon Social"  title="Ingrese solo letras" /> </td>
                                                    </tr>
                                                    <tr>
                                                    <td>Giro: </td>
                                                    <td> <input type="text" name="TxtGiro"class="form-control" value="<?php echo $row[2]; ?>"required placeholder="Ingrese su Giro"/> </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Direccion: </td>
