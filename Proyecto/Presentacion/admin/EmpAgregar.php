                    ...
                    <form action="../../Controladores/ValidadorEmpresa.php" name="Validador" method="post">
                        ...
                        <table class="table-active">
                            <tbody>
                                ...
                                <tr>
                                    <td>Razon Social: </td>
                                    <td> <input type="text" name="TxtRazon"class="form-control" value=""required placeholder="Ingrese la razon social"  /> </td>
                                </tr>
                                <tr>
                                    <td>Giro: </td>
                                    <td> <input type="text" name="TxtGiro"class="form-control" value=""required placeholder="Ingrese su Giro"/> </td>
                                </tr>
                                <tr>
                                    <td>Direccion: </td>
                                    <td> <input type="text" name="TxtDireccion"class="form-control" value="" required placeholder="Ingrese la direccion" /> </td>
                                </tr>
                                    <td colspan="2">
									<br>
