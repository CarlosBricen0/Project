...
if (isset($_SESSION['usuario']) and $_SESSION['estado'] == 'Autenticado' && $_SESSION['nivel'] == 'operador') {
    // Tiene Permisos para entrar
} else {
    // Usuario no logeado no entra
    echo '<script language="javascript">alert("No tienes permiso para entrar a esta pagina");window.location.href="../../index.php";</script>';
    exit();
}
?>
		...
		<div class="col-md-8 content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
				   ...
				   <img src="https://www.expoknews.com/wp-content/uploads/2018/10/Bienvenido.jpg" />
				   <img src="https://i.pinimg.com/originals/47/f0/34/47f0342cec72b800463bf003eac1257e.gif"  width="150" height="225" >
